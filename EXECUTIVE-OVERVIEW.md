...
## 📦 What it is
Total Recall is an extension (version 1.1.21) that plugs into Claude Code and Gemini CLI. Memories are Markdown files stored locally on your machine (under `~/.total-recall/`), organised in two places:
